...
namespace Shopping.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        {
            // TẠO VIEWDATA ĐỂ DÙNG PHÂN LOẠI PERMISSION CỦA DANH SÁCH TÀI KHOẢN
            ...
            var marketGOContext = _context.Accounts.Include(a => a.Role);
            return View(await marketGOContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MarketGOContext.Accounts'  is null.");
            }
            var account = await _context.Accounts.FindAsync(id);
            if (account != null)
            {
