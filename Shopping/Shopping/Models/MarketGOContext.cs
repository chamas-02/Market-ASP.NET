...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\FIRST;Database=MarketGO;Integrated Security=true;User Id=sa;Password=06082001;Trusted_Connection=True;MultipleActiveResultSets=true;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Discount>(entity =>
        {
            ...
            entity.HasOne(d => d.Creator).WithMany(p => p.Discounts)
                ...
                .HasConstraintName("FK_Discounts_Creators");
        });
        ...
        modelBuilder.Entity<ProductDiscount>(entity =>
        {
            ...
            entity.HasOne(d => d.Creator).WithMany(p => p.ProductDiscounts)
                .HasForeignKey(d => d.CreatorId)
                .HasConstraintName("FK_PDs_Creators");

            entity.HasOne(d => d.Discount).WithMany(p => p.ProductDiscounts)
                .HasForeignKey(d => d.DiscountId)
                .HasConstraintName("FK_PDs_Discounts");

            entity.HasOne(d => d.Product).WithMany(p => p.ProductDiscounts)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK_PDs_Products");
        });
        ...
        modelBuilder.Entity<ProductLike>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.ProductLikes)
                .HasForeignKey(d => d.CustomerId)
                .HasConstraintName("FK_PLs_Customers");

            entity.HasOne(d => d.Product).WithMany(p => p.ProductLikes)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK_PLs_Products");
        });
